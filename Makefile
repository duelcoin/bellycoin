#############################################################################
# Makefile for building: bellycoin-qt
# Generated by qmake (2.01a) (Qt 4.8.4) on: Thu Mar 5 21:24:02 2015
# Project:  bellycoin-qt.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe "USE_UPNP=- bellycoin-qt.pro" -o Makefile bellycoin-qt.pro
#############################################################################
...
Makefile: bellycoin-qt.pro  ../Qt/4.8.4/mkspecs/win32-g++/qmake.conf ../Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) "USE_UPNP=- bellycoin-qt.pro" -o Makefile bellycoin-qt.pro
